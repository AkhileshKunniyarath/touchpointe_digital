...
export function WhatsAppButton() {
  ...
  // Placeholder phone number. The user will be able to update this in the code.
  const phoneNumber = "YOUR_WHATSAPP_NUMBER"; 
  const message = encodeURIComponent("Hi Touchpointe, I would like to discuss a project.");
